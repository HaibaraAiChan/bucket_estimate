	...
	for run in range(args.num_runs):
		...
		for epoch in range(args.num_epochs):
			...
			if args.num_batch > 1:
				...
				# for step, (input_nodes, seeds, blocks) in enumerate(b_block_dataloader):
				# 	print('degree\t \t'+ str(step+1) + ' \t modified redundancy \t'+str(len(input_nodes)/len(seeds)/(step+1)))

				# print('len(input_nodes)/len(seeds) ')
				# for step, (input_nodes, seeds, blocks) in enumerate(b_block_dataloader):
				# 	print(len(input_nodes)/len(seeds))
				# print()
				# print('len(input_nodes)/len(seeds)/[(step+1)*0.441] ')
				# for step, (input_nodes, seeds, blocks) in enumerate(b_block_dataloader):
				# 	print(len(input_nodes)/len(seeds)/(step+1)/0.441)
				# print()		
				# print('len(input_nodes)/len(seeds)/(step+1)*0.441 ')
				...
				# print()		
				# print('_+_+'*30)	
				# print('len(input_nodes)/len(seeds)/(step+1)*(25*0.441)/50.5')
				# print(25*0.441)
				# for step, (input_nodes, seeds, blocks) in enumerate(b_block_dataloader):
				# 	print(len(input_nodes)/len(seeds)/(step+1)*(25*0.441)/50.5)
				# print('_+_+'*30)

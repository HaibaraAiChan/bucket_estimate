...
def estimate(data_dict):
	...
	for data in data_dict:
		...
		estimated_mem_list.append([value,estimated_mem])
		modified_estimated_mem_list.append([value,estimated_mem/3])
	...
	for run in range(args.num_runs):
		...
		for epoch in range(args.num_epochs):
			...
			if args.num_batch > 1:
				...
				modified_res, res = estimate(data_dict)
				# items = [(60, 10), (100, 20), (120, 30)]  # (value, weight)
				# items = [(1, mem_estimation), (1, mem_estimation), (1, mem_estimation)...]  # (value, weight)
				# items = res
				items = modified_res
				capacity = 22
				...
				print('the estimated memory of this constraint ', est_mem)
